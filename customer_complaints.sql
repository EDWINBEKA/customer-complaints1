...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.0.2&nocache=6319293881ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.0.2" media="print" id="printcss">
    <title>localhost / MySQL | phpMyAdmin 5.0.2</title>
...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"db_structure.php",lang:"en",server:"1",table:"",db:"",token:"4d2a2e3c447c237056774e714f5c2e42",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Browse",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",PMA_VERSION:"5.0.2",auth_type:"cookie",user:"root"});
      ...
      <div id="pma_navigation_header">
        ...
        <div id="navipanellinks">
          ...
          <a id="pma_navigation_reload" href="#" title="Reload navigation panel"><img src="themes/dot.gif" title="Reload navigation panel" alt="Reload navigation panel" class="icon ic_s_reload"></a>
                  ...
                  <div id="serverChoice">
            <form method="post" action="index.php" class="disableAjax"><input type="hidden" name="token" value="4d2a2e3c447c237056774e714f5c2e42"><label for="select_server">Current server:</label> <select name="server" id="select_server" class="autosubmit"><option value="">(Servers) ...</option>
...
<input type="hidden" name="token" value="4d2a2e3c447c237056774e714f5c2e42">
